                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <%
                            if(!nombre.equals("")){%>
                                ...
                                <li class="active"><a href="juego.jsp">Jugar</a></li>  
    ...
    <section id="bottom">
        ...
        <div class="container wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            <div class="center wow fadeInDown">
                <br><center><font size = 10>Sistema no conjuntado<br>Espere por favor.</font>
                </center>
                <%String red = "";
