<%-- 
    Document   : NoSuficiente
    Created on : 27/05/2016, 11:59:26 AM
...
<head>
    ...
    <title>No Suficiente | Mohnblumen</title>
    ...
    <section id="bottom">
        ...
        <div class="container wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            <div class="center wow fadeInDown">
                <br><center><font size = 10>No cuentas con la cantidad suficiente de reactivos para hacer esta reacción.</font>
                </center>
                <a href="Reacciones.jsp"><b>Volver</b></a> 
                <br><br><br>
            </div></div>
    </section>
