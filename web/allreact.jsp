<%-- 
    Document   : allreact
    Created on : 15/05/2016, 11:38:37 PM
        ...
        <nav class="navbar navbar-inverse navbar-static-top navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="img/ICON2.png" width="150" alt="logo"></a>
                </div>
    ...
    <section id="bottom">
        ...
        <center><table border=0>
            ...
            <center><th><center>Icono
                ...
                <tr>
                    <td>H<sub>2</sub>
                    <td>Hidrógeno (Diatómico)
                    <td>Molécula
                    <td><img src="img/Po1.png" height="50"> 
                </tr>
                <tr>
                    <td>NaClO
                    <td>Hipoclorito de Sodio
                    <td>Sal (Oxisal)
                    <td><img src="img/Po3.png" height="50">
                </tr>
                <tr>
                    <td>Na<sub>2</sub>CO<sub>3</sub>
                    <td>Carbonato de Sodio
                    <td>Sal (Oxisal)
                    <td><img src="img/Po5.png" height="50">
                </tr>
