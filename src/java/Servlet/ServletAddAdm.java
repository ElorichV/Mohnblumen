 ...
 * @author Jos
 */
public class ServletAddAdm extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
            ...
            try{
                ...
                String priv = req.getParameter("adm");
                ...
                if(corre == 0){
                    if(clave == 0){
                        if(nickname == 0){
                            conexion.update("call agregar_usuario('" + Nombre +"','" + App +"','" + Apm +"','" + Mail +"','" + Year + "-" + Month + "-"+ Day + "','" + Genero +"','" + Curp +"','" + Dep +"','" + Nic +"','" + Pas +"','" + priv +"');");                            
                            res.sendRedirect("UsuarioAgregado.jsp"); 
                        } else {                            
